...
echo "  AZURE_CREDENTIALS: run 'MSYS_NO_PATHCONV=1 az ad sp create-for-rbac --name hohmann-atlas-ci --role contributor --scopes /subscriptions/$SUB_ID/resourceGroups/$RESOURCE_GROUP'"
