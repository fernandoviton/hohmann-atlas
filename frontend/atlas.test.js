...
import {
  ...
  setOrigin, setTourData, setPlanets,
...
// ─── Integration: tour flow ───

describe('integration: tour flow', () => {
  it('load data → click row → data reloads → selection persists', () => {
    const s = createState();
    setPlanets(s, PLANETS);
    setOrigin(s, 'Earth');
